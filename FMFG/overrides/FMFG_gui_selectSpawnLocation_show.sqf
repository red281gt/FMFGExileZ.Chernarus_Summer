...
FNC_GET_ACTUAL_LOADOUT = {
	...
	switch (_this) do {
		...
		case 1:{
			if !(_puid in Scout1 + Scout2 + Scout3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Scout Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Scout Loadout 1</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 2:{
			if !(_puid in Scout2 + Scout3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Scout Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Scout Loadout 2</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 3:{
			if !(_puid in Scout3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Scout Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Scout Loadout 3</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 4:{
			if !(_puid in Marksman1 + Marksman2 + Marksman3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Marksman Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Marksman Loadout 1</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 5:{
			if !(_puid in Marksman2 + Marksman3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Marksman Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Marksman Loadout 2</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 6:{
			if !(_puid in Marksman3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Marksman Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Marksman Loadout 3</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 7:{
			if !(_puid in Soldier1 + Soldier2 + Soldier3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Soldier Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Soldier Loadout 1</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 8:{
			if !(_puid in Soldier2 + Soldier3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Soldier Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Soldier Loadout 2</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 9:{
			if !(_puid in Soldier3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Soldier Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Soldier Loadout 3</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 10:{
			if !(_puid in Medic1 + Medic2 + Medic3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Medic Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Medic Loadout 1</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 11:{
			if !(_puid in Medic2 + Medic3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Medic Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Medic Loadout 2</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 12:{
			if !(_puid in Medic3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Medic Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Medic Loadout 3</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 13:{
			if !(_puid in Engineer1 + Engineer2 + Engineer3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Engineer Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Engineer Loadout 1</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 14:{
			if !(_puid in Engineer2 + Engineer3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Engineer Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Engineer Loadout 2</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
		...
		case 15:{
			if !(_puid in Engineer3) then {[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Only Available for Engineer Loadout Donators.</t>"],0,0,10,0] spawn bis_fnc_dynamictext;} else {
			[parseText format["<img size='2' shadow='0' image='FMFG\images\logo.paa'/><br/><t size='0.7'font='OrbitronLight'>Engineer Loadout 3</t>"],0,0,10,0] spawn bis_fnc_dynamictext;
