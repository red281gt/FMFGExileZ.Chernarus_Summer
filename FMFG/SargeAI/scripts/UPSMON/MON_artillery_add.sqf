/*  =====================================================================================================
 ...
 =====================================================================================================		
	Parámeters: [_artillery,(_rounds,_area,_cadence,_mincadence)] execvm "FMFG\SargeAI\scripts\UPSMON\MON_artillery_add.sqf";	
 ...
 =====================================================================================================
	...
	2. Exec module in int of static weapon
		...
		nul=[this] execVM "FMFG\SargeAI\scripts\UPSMON\MON_artillery_add.sqf";
