...
UPSMON = compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON.sqf";
UPSMON_CreateGroup = compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\UPSMON_CreateGroup.sqf";

//Core
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\COMMON\Core\init.sqf";
call compile preprocessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\Get_pos\UPSMON_pos_init.sqf";
//Params
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\COMMON\Group\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\COMMON\target\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\COMMON\unit\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\COMMON\Params\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\COMMON\buildings\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\COMMON\vehicles\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\COMMON\cover\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\COMMON\terrain\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\COMMON\MP\init.sqf";
//Modules
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\FORTIFY\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\AMBUSH\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\ARTILLERY\init.sqf";
//Orders
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\ORDERS\UPSMON_PATROL\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\ORDERS\UPSMON_REINFORCEMENT\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\ORDERS\UPSMON_Transport\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\ORDERS\UPSMON_PATROLSRCH\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\ORDERS\UPSMON_FLANK\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\ORDERS\UPSMON_ASSAULT\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\ORDERS\UPSMON_DEFEND\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\ORDERS\UPSMON_RELAX\init.sqf";
call compile preProcessFileLineNumbers "FMFG\SargeAI\scripts\UPSMON\MODULES\ORDERS\UPSMON_SUPPLY\init.sqf";

[] execvm "FMFG\SargeAI\scripts\UPSMON\COMMON\CORE\fnc\UPSMON_TRACK.sqf";
[] execvm "FMFG\SargeAI\scripts\UPSMON\UPSMON_MAINLOOP.sqf";
[] execvm "FMFG\SargeAI\scripts\UPSMON\UPSMON_MAINLOOPCiv.sqf";
