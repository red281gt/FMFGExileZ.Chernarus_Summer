...
call compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_config.sqf";
...
SAR_AI_hit				= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_aihit.sqf";
SAR_AI_trace			= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_trace_entities.sqf";
SAR_AI_base_trace		= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_trace_base_entities.sqf";

if (!isServer) exitWith {};

SAR_AI					= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_setup_AI_patrol.sqf";
SAR_AI_heli				= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_setup_AI_patrol_heli.sqf";
SAR_AI_land				= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_setup_AI_patrol_land.sqf";
SAR_AI_trace_veh		= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_trace_from_vehicle.sqf";
SAR_AI_reammo			= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_reammo_refuel_AI.sqf";
SAR_AI_spawn			= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_AI_spawn.sqf";
SAR_AI_despawn			= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_AI_despawn.sqf";
SAR_AI_killed			= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_aikilled.sqf";
SAR_AI_VEH_HIT			= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_ai_vehicle_hit.sqf";
SAR_AI_GUARDS			= compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_setup_AI_patrol_guards.sqf";

call compile preprocessFileLineNumbers "FMFG\SargeAI\sarge\SAR_functions.sqf";
...
if (SAR_dynamic_spawning) then {
	...
	try {
		...
		call compile preprocessFileLineNumbers (format ["FMFG\SargeAI\sarge\map_config\SAR_cfg_grid_%1.sqf",_worldname]);
	} catch {
	...
	["dynamic"] call compile preprocessFileLineNumbers (format ["FMFG\SargeAI\sarge\map_config\SAR_cfg_grps_%1.sqf",_worldname]);
	diag_log format["Sarge's AI System: Spawn definitions have been configured."];
};

diag_log format["Sarge's AI System: Now initializing spawn definitions for %1.",_worldname];
["static"] call compile preprocessFileLineNumbers (format ["FMFG\SargeAI\sarge\map_config\SAR_cfg_grps_%1.sqf",_worldname]);
diag_log format["Sarge's AI System: Spawn definitions have been configured."];

if (SAR_Base_Gaurds) then {
	[] execVM "FMFG\SargeAI\sarge\SAR_init_Base_guards.sqf";
};
